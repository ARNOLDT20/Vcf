...
<head>
    ...
    <title>T20 Classic Tech - Contact Directory</title>
    ...
    <style>
        ...
        * {
        ...
        body::before {
            ...
            bottom: 0;
            background: 
                radial-gradient(circle at 20% 30%, rgba(243, 156, 18, 0.1) 0%, transparent 40%),
                radial-gradient(circle at 80% 70%, rgba(26, 74, 122, 0.2) 0%, transparent 40%);
            pointer-events: none;
            z-index: -1;
        }
...
<body>
    ...
    <div class="container">
        ...
        <div class="footer">
            <p>&copy; 2025 T20 Classic Tech. All rights reserved. | Contact Directory v2.0</p>
...
`;
            ...
            a.href = url;
            a.download = `T20_Classic_Tech_Contacts_${new Date().toISOString().split('T')[0]}.vcf`;
